package net.uweeisele.kstreams.example;

import net.uweeisele.kstreams.rest.JettyJerseyRestServerBuilder;
import net.uweeisele.kstreams.rest.RestServer;
import net.uweeisele.kstreams.rest.resource.local.InstanceResource;
...
public class WordCountInteractiveQueriesExample {
    ...
    static final String TEXT_LINES_TOPIC = "source";
    ...
    public static void main(final String[] args) throws Exception {
        ...
        RestServer restServer = new JettyJerseyRestServerBuilder(port)
                .withResource(new InstanceResource(streams, new HostInfo(DEFAULT_HOST, port)))
                .build();
        restServer.start();
